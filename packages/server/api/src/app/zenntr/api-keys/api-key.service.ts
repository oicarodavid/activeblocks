...
import { ZenntrApiKeyEntity } from './api-key.entity'
import { apId, ActivepiecesError, ErrorCode, ApId } from '@activepieces/shared'
...
export const zenntrApiKeyService = {
     ...
     */
    async verify(apiKey: string): Promise<any | null> {
